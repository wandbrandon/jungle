...
final User jeff = User(
  ...
  age: 21,
    ...
    messages: joeMessages,
  imageUrl: 'https://i.guim.co.uk/img/media/25aec7f2db66a5f8cf2ee3da96c361b3a105bf8c/0_0_2347_2346/master/2347.jpg?width=700&quality=85&auto=format&fit=max&s=eca2838686532ecbc1a0ec55b080b672',
);
final User hillary = User(
  id: 2,
  name: 'Hillary',
  imageUrl: 'https://external-preview.redd.it/MvTIeWiEQqB8UEdtg-6xdOQ73vSdtSIBAGTQrTz4jHA.jpg?auto=webp&s=7c9ad4de71c75cb0cf42ab083e473ff0a1488d98',
  age: 21,
    location: "Gainesville, FL",
    bio: "I'm a woman democrat",
    work: "Not the president",
    uni: "University of Shit",
    hometown: "Capitol Hill, DC",
    messages: joeMessages,
);
final User donald = User(
  id: 3,
  name: 'Donald',
  imageUrl: 'https://i.insider.com/57b5bea1db5ce9b20f8b7737?width=987&format=jpeg',
  age: 21,
    location: "Gainesville, FL",
    bio: "pls vote for me I need it, I love to make fun of the news, I love to lie to the press, and I also enjoy having my wife's boyfriend take me out on trips.",
    work: "Ex President of the US",
...
final User bill = User(
  id: 4,
  name: 'Bill',
  imageUrl: 'https://static.politico.com/8f/0c/5f5df7c945ec812c412ecc390bf3/clinton-3.jpg',
  age: 21,
    location: "Gainesville, FL",
...
final User joe = User(
  id: 5,
  name: 'Joe',
  imageUrl: 'https://static01.nyt.com/images/2020/09/18/us/politics/00young-biden/00young-biden-videoSixteenByNineJumbo1600.jpg',
  age: 21,
    location: "Gainesville, FL",
...
// FAVORITE CONTACTS
List<User> favorites = [joe, donald, bill, jeff, hillary];
...
List<Message> donaldMessages = [
  Message(
    id: 3,
    time: '5:30 PM',
    text: 'dude you are a fucking black',
    isLiked: true,
    unread: true,
  ),
  Message(
